...
Route::get('/datarcv', function () {
    return view('api.datarcv');
});
Route::post('/data','ApiController@index' );

Route::get('/welcome_bat','ApiController@welcome_bat');
Route::get('/function','ApiController@function_api');

Route::get('/contact','ApiController@contact_api');
Route::get('/leadership','ApiController@leadership_api');


Route::get('/check','ApiController@check');
Route::get('/test','ApiController@business_at_a_glance');
Route::get('/business','ApiController@business_at_a_glance');
// Auth::routes();
